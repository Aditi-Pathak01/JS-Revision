 ...
 * var,let,const and all Fx have hoisiting in them!(notess:-initialization and acces b4  declaration)
 * var can be redeclared and redefined,(fx scope), doesnt repect block scope in if et
